...
ASSIGNMENTS: dict[str, Assignment] = {
    ...
    "data/reviews/2024 언어이해 홀수형/q01.review.json": Assignment("CONCEPT_LAYER_CONFUSION", (), "high", "법전을 권위의 원천으로 삼는 구조와 그 법전을 해석하는 관점이라는 서로 다른 층위를 혼합했다."),
    "data/reviews/2024 언어이해 홀수형/q03.review.json": Assignment("SCOPE_CONDITION_MISAPPLICATION", ("CONCEPT_LAYER_CONFUSION",), "high", "법률 바깥의 법명제를 법체계 바깥의 비판으로 확장해 기준 명사와 제도적 층위를 바꾸었다."),
    "data/reviews/2024 언어이해 홀수형/q07.review.json": Assignment("CONCEPT_LAYER_CONFUSION", ("SCOPE_CONDITION_MISAPPLICATION",), "high", "직접비용과 기회비용을 구분하지 않고 가능성 선지에는 지문보다 강한 입증 조건을 요구했다."),
    "data/reviews/2024 언어이해 홀수형/q12.review.json": Assignment("TEXTUAL_REDEFINITION_MISSED", ("CONCEPT_LAYER_CONFUSION",), "high", "철학 개념의 표면적 명칭에 기대어 지문이 부여한 기능과 존재론적·인식론적 배치를 뒤집어 읽었다."),
    "data/reviews/2024 언어이해 홀수형/q15.review.json": Assignment("TABLE_DIAGRAM_ENCODING_ERROR", ("CHOICE_VERIFICATION_FAILURE",), "high", "편익과 비용을 주체·연도별 총액 계정으로 표에 고정하지 않고 순액화했으며 선택 선지의 계산도 생략했다."),
    "data/reviews/2024 언어이해 홀수형/q18.review.json": Assignment("TEXTUAL_REDEFINITION_MISSED", ("UNWARRANTED_ASSUMPTION_ADDED",), "high", "의사 진술과 내적 정합성의 지문상 정의를 넓혀 적용하고 지문 밖 핍진성 개념을 추가했다."),
    "data/reviews/2024 언어이해 홀수형/q19.review.json": Assignment("CONCEPT_LAYER_CONFUSION", (), "high", "명시 규정의 부재와 존재하는 규정의 의미에 관한 해석 논란을 같은 상태로 보았다."),
    "data/reviews/2024 언어이해 홀수형/q21.review.json": Assignment("SCOPE_CONDITION_MISAPPLICATION", (), "high", "효종의 실제 신분을 잘못 고정하고 반사실적 조건을 실제 사실처럼 처리했다."),
    "data/reviews/2024 언어이해 홀수형/q28.review.json": Assignment("SCOPE_CONDITION_MISAPPLICATION", (), "high", "가능한 행위 동기 하나를 모든 경우에 성립하는 제도적 번복 불가능 명제로 확장했다."),
    "data/reviews/2024 추리논증 홀수형/q04.review.json": Assignment("TABLE_DIAGRAM_ENCODING_ERROR", (), "high", "지역별 면적 비율과 용적률·건폐율 값을 반대로 대응시키고 첫 계산 충돌 뒤 재검산 없이 풀이를 중단했다."),
    "data/reviews/2024 추리논증 홀수형/q08.review.json": Assignment("GLOBAL_CONSTRAINT_DROPPED", ("CHOICE_VERIFICATION_FAILURE",), "high", "목표 범주가 두 조정의 영향 밖이라는 불변성을 확인하고도 끝까지 유지하지 않고 잘못된 산술값을 채택했다."),
    "data/reviews/2024 추리논증 홀수형/q12.review.json": Assignment("SCOPE_CONDITION_MISAPPLICATION", ("TEXTUAL_REDEFINITION_MISSED",), "high", "두 글자 이름의 규칙을 한 글자 이름에 확장하고 돌림자와 돌림변에 붙는 제한을 구분하지 않았다."),
    "data/reviews/2024 추리논증 홀수형/q13.review.json": Assignment("CONCEPT_LAYER_CONFUSION", (), "high", "동일한 원리를 적용한다는 요구와 동일한 책임 결론이 나와야 한다는 요구를 혼동했다."),
    "data/reviews/2024 추리논증 홀수형/q15.review.json": Assignment("TABLE_DIAGRAM_ENCODING_ERROR", ("CHOICE_VERIFICATION_FAILURE",), "high", "각 세계의 인구·평균·총합·분배 비교축을 표로 외부화하지 않고 필요한 계산과 선지 검산을 생략했다."),
    "data/reviews/2024 추리논증 홀수형/q16.review.json": Assignment("CONCEPT_LAYER_CONFUSION", (), "high", "사회 공리에 따른 허용 가능성과 자기희생에 따른 칭찬 가능성을 분리하지 못했다."),
    "data/reviews/2024 추리논증 홀수형/q27.review.json": Assignment("TEXTUAL_REDEFINITION_MISSED", (), "high", "가설의 분류 기준인 책임 주체 명시 여부를 증거의 확률성·신뢰도 기준으로 바꾸어 읽었다."),
    "data/reviews/2024 추리논증 홀수형/q37.review.json": Assignment("CONCEPT_LAYER_CONFUSION", (), "high", "메틸화가 조절 단백질 결합을 매개하는 단계와 이후 유전자 발현 결과를 혼동했다."),
